...
let oracion = prompt("Ingresa una oración de las menos tres palabras: ");

let procesarOracion = (oracion) => {
  let oracionSinEspacios = oracion.trim();
  let palabras = oracionSinEspacios.split(" ");
  let oracionConReemplazos = oracionSinEspacios.replace(/a/g, "@");
  let posicion = oracion.indexOf("javascript");
  let separadaPorGuiones = palabras.join("-");

  console.log(palabras);
  console.log(oracionConReemplazos);
  console.log(posicion);
  console.log(separadaPorGuiones);
};
